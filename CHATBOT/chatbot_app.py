...
def _render_cr_wizard() -> None:
    ...
    # Step 3 — Show current info, pick field
        ...
        st.markdown(
            ...
            f'  background: #111111 !important;'
            f'}}'
            f'div[data-testid="stExpander"] details summary :not(svg):not(path) {{'
            ...
            f'div[data-testid="stExpander"] details summary svg path {{'
            f'  stroke: {_pc_si} !important;'
            f'  fill: none !important;'
            f'}}'
